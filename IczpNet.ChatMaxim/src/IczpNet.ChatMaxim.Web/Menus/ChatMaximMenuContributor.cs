...
namespace IczpNet.ChatMaxim.Web.Menus;

public class ChatMaximMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ChatMaximMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<ChatMaximResource>();
